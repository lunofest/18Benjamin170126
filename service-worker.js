const CACHE_NAME = 'cache-v20'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v20',
    'estilos/styles.css?v20',
    'estilos/mediaQueries.css?v20',
    'javascript/script.js?v20',
